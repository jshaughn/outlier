...
func TestRule1(t *testing.T) {
	...
	assertEqual(t, Rule1.Name, d.Violations.Front().Value.(Rule).Name)
}
...
func TestRule2(t *testing.T) {
	...
	assertEqual(t, true, d.hasViolations())
	assertEqual(t, 1, d.Violations.Len())
	assertEqual(t, Rule2.Name, d.Violations.Front().Value.(Rule).Name)
}
...
func TestRule3_1(t *testing.T) {
	...
	assertEqual(t, true, d.hasViolations())
	assertEqual(t, 1, d.Violations.Len())
	assertEqual(t, Rule3.Name, d.Violations.Front().Value.(Rule).Name)
}
...
func TestRule4(t *testing.T) {
	...
	assertEqual(t, true, d.hasViolations())
	assertEqual(t, 1, d.Violations.Len())
	assertEqual(t, Rule4.Name, d.Violations.Front().Value.(Rule).Name)
}
...
func TestRule5(t *testing.T) {
	...
	d.AddSamples(testSamples)
	assertEqual(t, 1, d.Violations.Len())
	assertEqual(t, Rule5.Name, d.Violations.Front().Value.(Rule).Name)
}
...
func TestRule6(t *testing.T) {
	...
	d.AddSamples(testSamples)
	assertEqual(t, 1, d.Violations.Len())
	assertEqual(t, Rule6.Name, d.Violations.Front().Value.(Rule).Name)
}
...
func TestRule7(t *testing.T) {
	...
	d.AddSamples(testSamples)
	assertEqual(t, 1, d.Violations.Len())
	assertEqual(t, Rule7.Name, d.Violations.Front().Value.(Rule).Name)
}
...
func TestRule8(t *testing.T) {
	...
	d.AddSamples(testSamples)
	assertEqual(t, 1, d.Violations.Len())
	assertEqual(t, Rule8.Name, d.Violations.Front().Value.(Rule).Name)
}
